...
@ruta_cotizaciones.route('/EmpresaCotizaciones')
def EmpresaCotizaciones():
    ...
    return render_template("Empresas/cotizacionesEmpresas.html", productos=productos, clientes=clientes, vendedores=vendedores, ultimo_numero_factura=ultimo_numero_factura)
